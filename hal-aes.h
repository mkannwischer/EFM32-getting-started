...
void hal_aes128_ctr(uint8_t *out, size_t outlen, uint8_t *nonce, const uint8_t *key);
void hal_aes256_ctr(uint8_t *out, size_t outlen, uint8_t *nonce, const uint8_t *key);
